...
public class ReadFromExcel {
    public static String testData_dir = System.getProperty("user.dir") + "/src/test/java/TestData/UserData.xls.xlsx";
    ...
    static XSSFSheet sheet = workbook.getSheet("LoginDetails");
